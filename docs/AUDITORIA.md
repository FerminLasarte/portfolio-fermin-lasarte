...
- [x] **I12. Los mockups de teléfono muestran capturas horizontales recortadas** · Fase 1 (contenido) **[nav]**
  - **Hecho (2026-09-23):** TravelPic y DeporTurnos muestran capturas verticales reales en su tarjeta. TravelPic: tres capturas del simulador (barra de estado limpia, 920×2000): Inicio en la tarjeta, y en su página un abanico con el perfil de un fotógrafo y los medios de pago (`media.gallery`, docs/DISENO.md, 7.13), sobre el negro de la marca. Cada captura tiene su descripción. Vault, chatbot-ai, Bookit y el Compilador siguen con la placa tipográfica, que era opcional.
  ...
  - **2026-09-22, DeporTurnos:** captura de la pantalla Reservar, sacada del celular con la app publicada (Fermin la vendió y ya no tiene el código). Barra de estado tapada con blanco (filas 0–150 de 2622; la hora y la batería estaban en 74–119) y el avatar de la cuenta cambiado por uno genérico (círculo de 84px con centro en 1082,5 × 251,5), 828×1800, en `public/assets/deporturnos-reservas.webp`, sobre el violeta de la app (#A833E1). Es de una sola pantalla, así que queda quieta. La descripción va en `projects.deporturnos.shotAlt`: en la página del proyecto se lee; en la tarjeta la placa sigue oculta porque repite el botón. Las capturas piden la imagen por el ancho del teléfono (`SHOT_SIZES` en ProjectPlate), no por el de la placa.
  - **2026-09-23, DeporTurnos, cuatro más:** Fermin mandó cuatro capturas del celular (1206×2622, HEIC): los filtros de búsqueda, la ficha del complejo, sus horarios y la confirmación de la reserva. Van en `media.gallery` (`filters`, `venue`, `slots`, `confirm`), 828×1800, sin metadatos, cada una con su descripción en los dos idiomas. Lo que se tapó: la barra de estado (en los filtros, con el gris del fondo atenuado por la hoja, filas 0–170; en la ficha y los horarios, sobre la foto de la cancha, con un desenfoque que se desvanece en las filas 0–230, porque un recuadro liso se notaba), el avatar de la cuenta en los filtros (el genérico de Reservar, atenuado igual que el fondo, 117/255) y, en la confirmación, el perfil de otro jugador en "¿Con quién jugás?" (su foto y su nombre de usuario, cubiertos con el blanco del fondo; queda "Buscar").
...
- [x] **I15. UX de proyectos y CV** · Fase 1 (datos) y → Rediseño (presentación)
  - **2026-09-22:** cambia la parte de "enlaces directos a la tienda como acción principal". Ahora el botón relleno de cada tarjeta es "Ver el proyecto" y lleva a la página del proyecto (`/proyectos/<id>`); las tiendas, el repo y la demo siguen ahí, con borde, y se repiten en la página. Lo decidió Fermin al sumar las páginas de proyecto: con la tienda primero, la página quedaba escondida. Los enlaces directos no se perdieron, cambiaron de jerarquía.
