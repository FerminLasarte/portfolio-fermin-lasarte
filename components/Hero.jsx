...
// Hero (docs/DISENO.md, 7.2). En horizontal es un panel de una pantalla. Arriba, el
// titular de afiche (la segunda línea en contorno, como los años de Trayectoria) y a su
// lado la disponibilidad, el párrafo y los botones; abajo, el nombre. El nombre va en el
// <h1> como texto real; las letras sueltas son solo visuales, para la entrada letra por
// letra (styles/motion.css). La foto es el LCP: sin animación de entrada.
  ...
  return (
    ...
    >
      <div className="hero__intro">
        {/* Dos líneas visuales; el espacio entre ellas es para que se lea como una frase. */}
        <p className="hero__claim poster">
          <span className="hero__claim-line">{t("hero.claim.1")}</span>{" "}
          <span className="hero__claim-line hero__claim-outline">{t("hero.claim.2")}</span>
        </p>
        <div className="hero__copy">
          <p className="hero__avail meta">
            {t("hero.availability")} · {PERSON.city}
          </p>
