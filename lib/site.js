...
// Las apps en producción: las que cuenta "apps en producción". Son las móviles
// (`platforms`) y las de escritorio (capturas en ventana, como Vault); no cuenta los
// servicios web como chatbot-ai ni las apps que todavía no se publicaron o se están por
// relanzar.
const isLiveApp = (p) =>
  p.status === "live" && (p.platforms?.length > 0 || p.media?.type === "window");
...
// Cifras de la entrada de Proyectos (appsLive cuenta las apps en producción, móviles y
// de escritorio).
export const STATS = {
