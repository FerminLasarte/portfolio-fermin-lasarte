...
//
// `projects` es además la única con hijas: cada proyecto tiene su página en
// /proyectos/<id> (y /en/projects/<id>, con el mismo slug en los dos idiomas, que es
// lo que deja que el botón de idioma se quede en el mismo proyecto).
export const PAGES = {
