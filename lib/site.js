...
export const SKILL_GROUPS = [
  {
    ...
    skills: [
      ...
      { name: "React Native", icon: "reactnative/reactnative-original", level: "intermediate" },
    ],
  },
  {
    id: "backend",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Supabase", icon: "supabase/supabase-original", level: "intermediate" },
      { name: "SQLite", icon: "sqlite/sqlite-original", level: "intermediate" },
