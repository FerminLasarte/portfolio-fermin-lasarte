...
// cambiarla en los diez lugares. scripts/check.mjs, que corre antes de cada build,
// avisa si alguna copia quedó distinta (R-M31). Pide `screen` para que al imprimir la página sea
