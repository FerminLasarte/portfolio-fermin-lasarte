...
export const translations = {
  es: {
    ...
    // El titular del hero, en dos líneas: la segunda va en contorno (components/Hero.jsx).
    "hero.claim.1": "Apps móviles,",
    "hero.claim.2": "de punta a punta.",
    "hero.availability": "Disponible",
    "hero.lead": "Ingeniero de Sistemas. Diseño, programo y publico apps para iPhone y Android, con su backend.",
  ...
  en: {
    ...
    "hero.claim.1": "Mobile apps,",
    "hero.claim.2": "end to end.",
    "hero.availability": "Available",
    "hero.lead": "Systems Engineer. I design, build, and ship apps for iPhone and Android, backend included.",
