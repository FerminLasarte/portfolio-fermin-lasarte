...
// Las apps móviles en producción: las que cuenta "apps en producción" (no los servicios
// web como chatbot-ai ni las apps que todavía no se publicaron o se están por relanzar).
const isLiveApp = (p) => p.platforms?.length > 0 && p.status === "live";
