...
// Mezcla dos posiciones: como tienen los mismos comandos, alcanza con interpolar los
// números en orden. Es lo que hace GSAP en douglus, y por eso el movimiento va por el
// atributo `d` y no por la propiedad CSS del mismo nombre: esa no existe en Safari
// (probado el 2026-09-21, y caniuse lo confirma hasta la 27.2), así que con CSS la
// cortina no se veía y el parpadeo del hero volvía tal cual.
const NUMEROS = /-?\d+(?:\.\d+)?/g;

export function mezclar(de, a, t) {
