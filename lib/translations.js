...
export const translations = {
  es: {
    ...
    "exp.lead": "Estudiante avanzado de Ingeniería de Sistemas, con foco en mobile (Swift, Flutter) y backend.",
    ...
    "skills.pageLead": "Las tecnologías con las que trabajo, qué tan bien las manejo y en qué proyectos de esta página las usé.",
    "skills.usedIn": "Usada en",
    "skills.matrixTitle": "Dónde las usé",
    "skills.matrixLead": "Cada punto es un proyecto de esta página.",
    ...
    "strip.credit": "Hecho a mano en Buenos Aires",
  ...
  en: {
    ...
    "strip.credit": "Handmade in Buenos Aires",
