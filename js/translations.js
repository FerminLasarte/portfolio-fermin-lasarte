const translations = {
    ...
    en: {
        ...
        "projects.p5.desc": "Natively developed iOS game using Swift, handling complex state logic and native rendering.",
        "projects.p6.title": "Beltrán Portfolio with AI",
        "projects.p6.desc": "Professional portfolio powered by Artificial Intelligence. Integrates an AI assistant to guide visitors, dynamic content generation, and interaction analytics — all wrapped in a high-impact visual experience.",
        "projects.p7.title": "Barbershop Booking App",
        "projects.p7.desc": "Mobile app built with Flutter for intelligent appointment management at barbershops. Enables real-time bookings, automated reminders, and a dedicated barber control panel.",
        "projects.p8.title": "ClubSync — Sports Club System with AI",
        "projects.p8.desc": "Multi-tenant SaaS platform for comprehensive sports club management. Includes a web admin panel, a member mobile app, and AI-powered features for insights and automation.",
