...
export const translations = {
  es: {
    ...
    "exp.intro":
      "Estudiante avanzado de Ingeniería de Sistemas (UNICEN) con sólido enfoque en desarrollo móvil (Swift, Flutter) y backend. Experiencia creando soluciones de punta a punta, desde la arquitectura del sistema hasta la publicación en tiendas.",
    "hero.projectsBtn": "Ver proyectos",
    "hero.cvBtn": "Descargar CV",

    "exp.kind.work": "Experiencia",
    "exp.kind.edu": "Educación",
    "exp.lead": "Estudiante avanzado de Ingeniería de Sistemas, con foco en desarrollo móvil (Swift, Flutter) y backend.",
  ...
  en: {
    ...
    "exp.intro":
      "Final-year Systems Engineering student (UNICEN) with a strong focus on mobile development (Swift, Flutter) and backend. Experience building end-to-end solutions, from system architecture to app store publishing.",
    "hero.projectsBtn": "View projects",
    "hero.cvBtn": "Download CV",

    "exp.kind.work": "Work",
    "exp.kind.edu": "Education",
    "exp.lead": "Final-year Systems Engineering student focused on mobile (Swift, Flutter) and backend.",
    "exp.ongoing": "ongoing",
