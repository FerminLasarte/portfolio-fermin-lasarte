...
export const translations = {
  es: {
    ...
    "meta.ogAlt": "{title}. Desarrollador Swift, Flutter y Backend.",
    ...
    "exp.travelpic.company": "Creador de TravelPic | Argentina",
    "exp.travelpic.desc":
    ...
    "edu.languages.desc":
      "Nivel intermedio-avanzado (B2) en los dos idiomas. Capacidad fluida para la lectura de documentación técnica, escritura de código y colaboración eficaz en equipos internacionales y multidisciplinarios.",

    "skills.title": "Mis Habilidades",
    "skills.mobile": "Mobile",
    "skills.backend": "Backend",
    "skills.web": "Web",
    "skills.db": "Bases de Datos & Cloud",
  ...
  en: {
    ...
    "meta.ogAlt": "{title}. Swift, Flutter & Backend Developer.",
    ...
    "exp.travelpic.company": "Creator of TravelPic | Argentina",
    "exp.travelpic.desc":
    ...
    "exp.deporturnos.company": "Originator and Creator of DeporTurnos | Argentina",
    "exp.deporturnos.desc":
    ...
    "edu.languages.desc":
      "Upper-intermediate level (B2) in both languages. Fluent ability to read technical documentation, write code, and collaborate effectively in international and multidisciplinary teams.",
