...
//    (styles/motion.css). A los 3,4 s (--pl-zoom) ya se está yendo solo y no hace
//    falta. Si las animaciones no corren, a los 7 s se saca igual.
export const themeInitScript = `(function () {
  ...
  try {
    if (!sessionStorage.getItem('preloader') && !window.matchMedia('${REDUCED_MOTION}').matches) {
      ...
      setTimeout(off, 3400);
      setTimeout(function () { root.classList.remove('pl'); }, 7000);
