...
// instancia de Lenis, así las anclas y "Volver al inicio" usan la misma inercia que la
...
// La curva de los saltos largos: 1 − (1 − t)³, una ease-out cúbica. No es la de
// douglus: su Lenis usa 1 − 2^(−10t) (docs/DISENO.md, anexo A).
